#!/bin/bash
#########################################
## AIStack, v. 0.7.5-FPOS (21/09/2018) ##
...
# Distributions
git clone --recursive https://github.com/posterior/distributions.git
cd distributions
pip install --upgrade --no-deps .
cd ../
